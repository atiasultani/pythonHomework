...
# Please type the following affirmation: I am capable of doing 
...
# Note that you can call input() with no prompt and it will still wait 
# for a user to type something!
