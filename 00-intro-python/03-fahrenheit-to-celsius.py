...
# (this can be a number with decimal places!) and 
# outputs the temperature converted to Celsius.

# The Celsius scale is widely used to measure temperature, 
# but places still use Fahrenheit. Fahrenheit is another unit for 
# temperature, but the scale is different from Celsius -- 
...
def main():
    ...
    degrees_fahrenheit:str=input(f"Enter temperature in Fahrenheit:")
